...
describe('ZoneChecker', () => {
    ...
    describe('Rectangle Zone Tests', () => {
        const topLeft: ZoneCoordinates = { lat: 55.363480869216595, lng: 24.321106992608996 };
        const bottomRight: ZoneCoordinates = { lat: 54.498960590750656, lng: 25.179308470701606 };
        ...
        it('should detect point inside rectangle', () => {
            ...
            const centerPoint: ZoneCoordinates = { lat: 54.67735825301103, lng: 24.62513352444934 };
        ...
        it('should detect point at rectangle boundaries', () => {
            ...
            expect(zoneChecker.checkPoint(topLeftPoint)).toEqual(['Vilnius Area']);
            expect(zoneChecker.checkPoint(bottomRightPoint)).toEqual(['Vilnius Area']);
        });
    ...
    describe('Polygon Zone Tests', () => {
        ...
        it('should handle complex polygon', () => {
            ...
            const centerPoint: ZoneCoordinates = { lat: 54.91, lng: 23.98 };
            const result = zoneChecker.checkPoint(centerPoint);
    ...
    describe('Multiple Zones Tests', () => {
        ...
        it('should return multiple zone names for overlapping zones', () => {
            const pointInMultipleZones: ZoneCoordinates = { lat: 54.9, lng: 24.0 };
    ...
    describe('Edge Cases', () => {
        it('should handle point with same coordinates as rectangle corner', () => {
            ...
            zoneChecker.addRectangleZone('Test', corner, { lat: 54.0, lng: 25.0 });
        ...
        it('should handle empty points array', () => {
            zoneChecker.addRectangleZone('Test', { lat: 55.0, lng: 24.0 }, { lat: 54.0, lng: 25.0 });
    ...
    describe('Real World Vilnius Coordinates', () => {
        ...
        it('should detect Vilnius city center', () => {
            const vilniusCityCenter: ZoneCoordinates = { lat: 54.69398563523757, lng: 25.275572610609277 };
        ...
        it('should reject coordinates outside Lithuania', () => {
            const outsideLithuania: ZoneCoordinates = { lat: 52.5200, lng: 13.4050 }; // Berlin
        ...
        it('should handle multiple real locations', () => {
            const realLocations: ZoneCoordinates[] = [
                ...
                { lat: 52.5200, lng: 13.4050 },    // Berlin (outside)
